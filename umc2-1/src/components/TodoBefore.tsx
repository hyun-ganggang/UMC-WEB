        ...
        <div className="list-container">
                ...
                <ul id="todo-list"className="list-container_list">
                    {todos.map((todo) => (
                        <li key={todo.id} className="list-container_item">
                            ...
                            <button onClick= {():void=>completeTodo(todo)}style={{backgroundColor:'green'}} className="list-container_item-button">완료</button>
                        </li>
                    ))}              
            </ul>
            </div>
            ...
            <div className="list-container_section">
                ...
                {doneTodos.map((todo) => (
                        <li key={todo.id} className="list-container_item">
                            <span className="list-container_item-text">{todo.text}</span>
                            <button onClick={()=>deleteTodo(todo)} style={{backgroundColor:'red'}} className="list-container_item-button">삭제</button>
                        </li>
                    ))}     
